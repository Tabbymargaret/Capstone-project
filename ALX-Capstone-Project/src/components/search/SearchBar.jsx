    ...
    <form onSubmit={handleSubmit} className="w-full flex justify-center mb-8">
      <div className="relative w-full max-w-2xl">
        <input
          ...
          onChange={(e) => setQuery(e.target.value)}
          placeholder="Search for songs, artists, or albums..."
          className="w-full px-6 py-4 pr-24 rounded-full border border-gray-300 
                   focus:outline-none focus:ring-4 focus:ring-blue-200 
                   focus:border-blue-500 text-lg shadow-md transition-all duration-200
                   hover:shadow-lg"
          disabled={isLoading}
        />
        ...
        {query && (
          <button
            ...
            onClick={handleClear}
            className="absolute right-16 top-1/2 transform -translate-y-1/2 
                     text-gray-400 hover:text-gray-600 p-2 transition-colors duration-200"
            disabled={isLoading}
          >
            ✕
          </button>
